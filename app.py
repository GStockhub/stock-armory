...
st.markdown(f"<h1 style='text-align: center;' class='highlight-primary'>💰️ 讓我賺大錢 v27.0</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;' class='text-sub'>—— 終極王者歸來 ✕ ATR 動態裝甲版 ——</p>", unsafe_allow_html=True)
...
st.divider()
st.markdown("<p style='text-align: center;' class='text-sub'>© 游擊隊軍火部 - V27.0 </p>", unsafe_allow_html=True)
