...
# ==============================================================================
# 【第二區塊：側邊欄 (Sidebar) & 紀律風控 & 👑 主題切換器】
# ==============================================================================

with st.sidebar:
    st.markdown("### ⚙️ 紀律設定")
    st.markdown("---")
    theme_choice = st.selectbox("🎨 戰情室佈景主題", ["ocean", "gold", "gray"], index=0, format_func=lambda x: {"ocean":"🌊 深海藍", "gold":"👑 黑金", "gray":"🧘 極簡灰"}.get(x))
...
st.markdown("<h1 style='text-align: center;' class='highlight-primary'>💰️ 我要賺大錢 v24.3</h1>", unsafe_allow_html=True)
